...
def media_especifica(intervaloData):
...
def media_meses_ano(intervaloData):
    ...
    for mes in meses:
        ...
        mean_df = media_especifica(intervalo_mes) # chame a função que calcula a media
